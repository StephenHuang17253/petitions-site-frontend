...
import {
    ...
    DialogTitle,
    DialogContent,
    DialogActions, Theme, IconButton, Grid
} from "@mui/material";
...
const MyPetitions = () => {
    ...
    const [showingOwned, setShowingOwned] = React.useState(true);
    ...
    React.useEffect(() => {
        ...
        if (showingOwned) {
            ...
            params += `&supporterId=${user.userId}`
        }
        ...
        getPetitions()
        updateQuery()
    }, [setPetitions, currentPage, inputQuery, supportingCostFilter, selectedCategories, petitionSortBy, showingOwned])
        ...
        <>
            ...
            <Container sx={{justifyContent: "center", display: "grid"}}>
                ...
                <TextField
                    ...
                    type="search"
                    style={{ textAlign: "left", width: "100%", marginTop: "16px" }}
                    variant="outlined"
                    multiline
                    maxRows={3}
                ...
                {/*<Button onClick={handleToggle} sx={{margin: "auto"}} variant={"contained"}>*/}
                {/*    {showingOwned ? "View your supported Petitions" : "View the Petitions you Own"}*/}
                {/*</Button>*/}
                ...
                <Grid container spacing={2} width={"100%"}>
                    <Grid item xs={12} sm={6}>
                        <Button
                            ...
                            sx={{ margin: 'auto', width: '100%', minHeight: "100%"}}
                            variant={showingOwned ? 'contained' : 'outlined'}
                        >
                            {showingOwned ? 'Viewing Petitions you Own' : 'View Petitions you Own'}
                        </Button>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <Button
                            onClick={() => handleToggle('supported')}
                            sx={{ margin: 'auto', width: '100%', minHeight: "100%" }}
                            variant={!showingOwned ? 'contained' : 'outlined'}
                        >
                            {!showingOwned ? 'Viewing Petitions you Support' : 'View Petitions you Support'}
                        </Button>
                    </Grid>
                </Grid>
            ...
            <Paper elevation={3} style={card} >
                ...
                <h3>Petitions You {showingOwned ? "Own" : "Support"}</h3>
